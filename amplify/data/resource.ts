...
const schema = a.schema({
  ...
  CartItem: a
    .model({
      ...
      selectedGraphicId: a.string(),
      selectedGraphicName: a.string(),
      selectedGraphicImageKey: a.string(),
      selectedGraphicImageUrl: a.string(),
  ...
  OrderItem: a
    .model({
      ...
      selectedGraphicIdAtTime: a.string(),
      selectedGraphicNameAtTime: a.string(),
      selectedGraphicImageKeyAtTime: a.string(),
      selectedGraphicImageUrlAtTime: a.string(),
